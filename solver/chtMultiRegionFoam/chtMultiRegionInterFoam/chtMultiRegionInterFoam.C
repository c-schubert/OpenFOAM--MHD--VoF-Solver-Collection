...
int main(int argc, char *argv[])
{
    ...
    const bool LTS = false; // local time stepping -> pseudo transient -> steady
    ...
    // const functionObjectList& myFuncObjList = runTime.functionObjects();

    // Info << "runTime.name(): " << runTime.names() << endl;
    // Info <<"Subcycling: " << runTime.subCycling() << endl;

    // forAll(myFuncObjList, i)
    // {

    // }

    // Info << runTime.functionObjects() << endl;
    ...
    while (runTime.run())
    {
        ...
        if (LTS)
        {
            // #include "setMultiRegionRDeltaT.H" // implement todo
        }
        else
        {
